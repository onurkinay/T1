 <?php get_header(); ?>
  ...
  <div id="content">
    ...
    <div class="recent">
	<h1><?php printf( __( '%a yazarının yazıları', 'twentytwelve' ), '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( "ID" ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' ); ?>
</h1>
		<?php if(have_posts()) : ?>
